(function () {
  ...
  function loadAdminStats() {
    fetch('admin_actions?action=get_stats')
      .then(r => r.json())
      .then(data => {
  ...
  function openModifyOfferModal(productId) {
    ...
    fetch(`admin_actions?action=get_offers`)
      .then(r => r.json())
      .then(data => {
  ...
  function viewAllUsers() {
    ...
    fetch('admin_actions?action=get_users')
      .then(r => r.json())
      .then(data => {
...
async function loadAllOrders() {
  ...
  try {
    const response = await fetch('admin_actions?action=get_all_orders');
...
async function updateOrderStatus(orderId) {
  ...
  try {
    ...
    const response = await fetch('admin_actions', {
      method: 'POST',
